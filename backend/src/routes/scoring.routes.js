...
router.post('/:id/pause', authenticateMatchToken, anyManager, validate(matchValidators.pauseMatchSchema), scoringController.pauseMatch);
...
router.post('/:id/substitute', authenticateMatchToken, anyManager, scoringController.addSubstitute);
