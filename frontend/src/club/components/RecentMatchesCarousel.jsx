...
export default function RecentMatchesCarousel({ clubId }) {
  ...
  return (
    <div className="relative group">
      ...
      <div
        ref={scrollRef}
        className="flex gap-4 overflow-x-auto pb-2 club-scroll snap-x snap-mandatory"
...
function MatchCard({ match, index }) {
  ...
  return (
    <motion.div
      ...
      className="glass-card min-w-[300px] max-w-[320px] p-4 flex-shrink-0 snap-start cursor-pointer"
    >
      ...
      {(match.result?.summary || winnerId) && (
        <div className="mt-3 pt-2 border-t border-white/5">
          <p
            ...
            style={{
              background: `var(--club-primary)12`,
