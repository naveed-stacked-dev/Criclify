  ...
  return (
    <div className="space-y-6">
      <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }}>
        ...
        <p className="text-sm text-gray-500 mt-1">All tournaments hosted by {club?.name}</p>
      </motion.div>
          ...
          {tournaments.map((t, i) => (
            ...
            >
              <div className="glass-card p-5 h-full flex flex-col">
                ...
                <div className="flex items-center gap-4 text-[11px] text-gray-500 mt-auto pt-3 border-t border-white/5">
